...
//                 <Link to="/destinations" className="nav-link" onClick={handleMenuIconClick}>
//                   Destinations
//                 </Link>
//               </li>
//               <li className="nav-item">
//                 <Link to="/hostels" className="nav-link" onClick={handleMenuIconClick}>
//                   Hostels
//                 </Link>
//               </li>
//               <li className="nav-item">
//                 <Link to="/workations" className="nav-link" onClick={handleMenuIconClick}>
//                   Workations
//                 </Link>
//               </li>
//               <li className="nav-item">
//                 <Link to="/membership" className="nav-link" onClick={handleMenuIconClick}>
//                   Membership
//                 </Link>
//               </li>
//               <li className="nav-item">
//                 <Link to="/blogs" className="nav-link" onClick={handleMenuIconClick}>
//                   Blogs
//                 </Link>
//               </li>
//             </ul>
...
function Mobilenav() {
  ...
  return (
    ...
    <div>
        <p className='logomainmobile'>SLEEPSAFARI</p>
    </div>
    </div>
  );
}
