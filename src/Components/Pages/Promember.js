  ...
  return (
    <div className="membership-join">
      ...
      <div className="card">
        ...
        <img src={Propic} alt='propic' className='Procardimg'/>
      ...
      <li>
        <FontAwesomeIcon style={{ marginRight: '13px' }} icon={faTree} />
        Member only trips, powered by Step Out Co
      </li>
    </ul>
        <button className='promembtn'>Join Now</button>
      </div>
      ...
      <img src={Propic1} alt='propic' className='Procardimg'/>
      ...
      <img src={Propic2} alt='propic' className='Procardimg'/>
